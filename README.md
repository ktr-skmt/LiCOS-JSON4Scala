...
https://ktr-skmt.github.io/LiCOS-JSON4Scala/0.2.6/api/index.html
...
```scala
libraryDependences += "online.licos" % "licos-json4scala_2.12" % "0.2.6"
```
...
```javascript
dependencies {
    compile group: 'online.licos', name: 'licos-json4scala_2.12', version: '0.2.6'
}
```
...
```xml
<dependency org="online.licos" name="licos-json4scala_2.12" rev="0.2.6"/>
```
