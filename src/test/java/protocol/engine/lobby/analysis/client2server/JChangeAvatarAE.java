...
public class JChangeAvatarAE implements ChangeAvatarAnalysisEngine {
    @Override
    public Try<LobbyMessageProtocol> process(LobbyBOX box, ChangeAvatarProtocol changeAvatarProtocol) {
        if (box instanceof JLobbyBox) {
            return Success.apply(LobbyMessageTestProtocol.apply(ChangeAvatar$.MODULE$.type()));
        } else {
