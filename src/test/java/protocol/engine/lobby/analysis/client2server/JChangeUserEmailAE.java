...
import static protocol.engine.lobby.example.client2server.ChangeUserEmail$.MODULE$;
...
public class JChangeUserEmailAE implements ChangeUserEmailAnalysisEngine {
    @Override
