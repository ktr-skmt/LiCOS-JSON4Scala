...
import licos.protocol.element.village.part.{BaseProtocol, ChatSettingsProtocol, VillageProtocol, VotingResultDetailProtocol, VotingResultSummaryProtocol}
...
object MorningPhaseProtocol {
  ...
  def read(json: JsonPhase): Option[MorningPhaseProtocol] = {
